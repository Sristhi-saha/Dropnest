...
const GetStart = ()=>{
    ...
    return(
        <>
                ...
                <div className="pt-4">
                    <button className='bg-teal-600 text-white px-8 py-3 hover:bg-teal-800 rounded-xl font-semibold text-xl'onClick={()=>navigate('/signup')}>Create Account Now</button>
                </div>  
            </div>
        </>
    )
